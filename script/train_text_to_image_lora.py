        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                if args.snr_gamma is None:
                    ...
                    snr = compute_snr(noise_scheduler, timesteps) # always compute snr 
                else:
            ...
            logs = { "loss": loss.detach().item(),"loss_log10": torch.log10(loss.detach()).item(), "lr": lr_scheduler.get_last_lr()[0],"snr":snr.item() ,"snr_log10": torch.log10(snr).item() }
